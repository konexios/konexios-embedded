...
VOID    _nx_trace_event_insert_stub(VOID);
VOID    _nx_trace_event_update_stub(VOID);
VOID    _nx_trace_object_register_stub(VOID);
VOID    _nx_trace_object_unregister_stub(VOID);
#endif
...
#define __NETXDUO_MINOR_VERSION__ 9
...
/* For backward compatibility, convert map NXDUO_DISABLE_ICMPV6_REDIRECT_PROCESS to NX_DISABLE_ICMPV6_REDIRECT_PROCESS */
...
UINT    nxd_icmp_ping(NX_IP *ip_ptr, NXD_ADDRESS *ip_address, CHAR *data_ptr, ULONG data_size, NX_PACKET **response_ptr, ULONG wait_option);
...
#ifndef NX_DISABLE_ERROR_CHECKING
UINT    _nxde_ip_raw_packet_send(NX_IP *ip_ptr, NX_PACKET **packet_ptr_ptr, NXD_ADDRESS *destination_ip, ULONG protocol, UINT ttl, ULONG tos);
#else /* NX_DISABLE_ERROR_CHECKING */
