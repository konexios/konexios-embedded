...
/*  05-11-2015     TCRG                     Modifeid comment(s), derived  */ 
/*                                            USB internal timeout values */ 
/*                                            from ThreadX timer tick     */ 
/*                                            frequency, resulting in     */ 
/*                                            version 5.7 SP1             */ 
/*  06-10-2015     TCRG                     Modifeid comment(s), fixed    */ 
/*                                            missing #endif, resulting   */
/*                                            in version 5.7 SP2          */ 
/*                                                                        */ 
/**************************************************************************/ 
...
#ifndef UX_HOST_CLASS_STORAGE_TRANSFER_TIMEOUT_IN_MS               
#define UX_HOST_CLASS_STORAGE_TRANSFER_TIMEOUT_IN_MS        100000
#endif
#define UX_HOST_CLASS_STORAGE_TRANSFER_TIMEOUT              ((UX_HOST_CLASS_STORAGE_TRANSFER_TIMEOUT_IN_MS) * (UX_PERIODIC_RATE) / 1000)

#ifndef UX_HOST_CLASS_STORAGE_CBI_STATUS_TIMEOUT_IN_MS      
#define UX_HOST_CLASS_STORAGE_CBI_STATUS_TIMEOUT_IN_MS      30000
#endif
#define UX_HOST_CLASS_STORAGE_CBI_STATUS_TIMEOUT            ((UX_HOST_CLASS_STORAGE_CBI_STATUS_TIMEOUT_IN_MS) * (UX_PERIODIC_RATE) / 1000)
