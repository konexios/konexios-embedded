...
/* Define the length of the client's unique identifier.  Must be at 
   least large enough to hold the hardware mac address(6 bytes) and hardware type 
   (1 byte). The default value is set to 8 for four-byte alignment.
*/

#ifndef NX_DHCP_CLIENT_IDENTIFIER_MAX
#define NX_DHCP_CLIENT_IDENTIFIER_MAX           8
#endif
