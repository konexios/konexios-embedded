...
// SW_Tx_UART_v1_50(BaudRate=115200, PinAssignmentMethod=1, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMPONENT_NAME=SW_Tx_UART_v1_50, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=SW_Tx_UART_1, CY_INSTANCE_SHORT_NAME=SW_Tx_UART_1, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=50, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  3.3 SP1, INSTANCE_NAME=SW_Tx_UART_1, )
module SW_Tx_UART_v1_50_0 ;
	...
	cy_psoc3_pins_v1_10
		#(.id("f29a9a06-d12b-4085-ba16-8c26d8f94f4f/52f31aa9-2f0a-497d-9a1f-1424095e13e6"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
...
module top ;
    ...
    SW_Tx_UART_v1_50_0 SW_Tx_UART_1 ();
	...
	cy_psoc3_pins_v1_10
		#(.id("adca4100-e7be-44f8-85a8-e5bcf08a2fde"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("27c35b57-1f9f-421e-b4f0-c0dd1e11ec16"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__SHD_LED_1_net;
	wire [0:0] tmpFB_0__SHD_LED_1_net;
	wire [0:0] tmpIO_0__SHD_LED_1_net;
	wire [0:0] tmpINTERRUPT_0__SHD_LED_1_net;
	electrical [0:0] tmpSIOVREF__SHD_LED_1_net;

	cy_psoc3_pins_v1_10
		#(.id("73bcd332-4a1d-48da-b824-468436c13a73"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		SHD_LED_1
		 (.oe(tmpOE__SHD_LED_1_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__SHD_LED_1_net[0:0]}),
		  .io({tmpIO_0__SHD_LED_1_net[0:0]}),
		  .siovref(tmpSIOVREF__SHD_LED_1_net),
		  .interrupt({tmpINTERRUPT_0__SHD_LED_1_net[0:0]}),
		  .annotation({Net_4150}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__SHD_LED_1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__SHD_LED_2_net;
	wire [0:0] tmpFB_0__SHD_LED_2_net;
	wire [0:0] tmpIO_0__SHD_LED_2_net;
	wire [0:0] tmpINTERRUPT_0__SHD_LED_2_net;
	electrical [0:0] tmpSIOVREF__SHD_LED_2_net;

	cy_psoc3_pins_v1_10
		#(.id("29957f92-0978-4bc7-b7e2-f708a4341fb4"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		SHD_LED_2
		 (.oe(tmpOE__SHD_LED_2_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__SHD_LED_2_net[0:0]}),
		  .io({tmpIO_0__SHD_LED_2_net[0:0]}),
		  .siovref(tmpSIOVREF__SHD_LED_2_net),
		  .interrupt({tmpINTERRUPT_0__SHD_LED_2_net[0:0]}),
		  .annotation({Net_4160}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__SHD_LED_2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
    ...
    cy_annotation_universal_v1_0 VDD_BLE (
        .connect({
            Net_4152
        })
    );
    defparam VDD_BLE.comp_name = "Power_v1_0";
    defparam VDD_BLE.port_names = "T1";
    defparam VDD_BLE.width = 1;
	...
	wire [0:0] tmpOE__TH_AL_net;
	wire [0:0] tmpFB_0__TH_AL_net;
	wire [0:0] tmpIO_0__TH_AL_net;
	wire [0:0] tmpINTERRUPT_0__TH_AL_net;
	electrical [0:0] tmpSIOVREF__TH_AL_net;

	cy_psoc3_pins_v1_10
		#(.id("a364e0eb-6ebf-4716-ab9d-e4c0145dd0c5"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		TH_AL
		 (.oe(tmpOE__TH_AL_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__TH_AL_net[0:0]}),
		  .io({tmpIO_0__TH_AL_net[0:0]}),
		  .siovref(tmpSIOVREF__TH_AL_net),
		  .interrupt({tmpINTERRUPT_0__TH_AL_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__TH_AL_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__TH_AH_net;
	wire [0:0] tmpFB_0__TH_AH_net;
	wire [0:0] tmpIO_0__TH_AH_net;
	wire [0:0] tmpINTERRUPT_0__TH_AH_net;
	electrical [0:0] tmpSIOVREF__TH_AH_net;

	cy_psoc3_pins_v1_10
		#(.id("ed7b3caf-91c9-431d-a272-b9bc54ceff5c"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		TH_AH
		 (.oe(tmpOE__TH_AH_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__TH_AH_net[0:0]}),
		  .io({tmpIO_0__TH_AH_net[0:0]}),
		  .siovref(tmpSIOVREF__TH_AH_net),
		  .interrupt({tmpINTERRUPT_0__TH_AH_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__TH_AH_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__MAG_SW_IN_net;
	wire [0:0] tmpFB_0__MAG_SW_IN_net;
	wire [0:0] tmpIO_0__MAG_SW_IN_net;
	wire [0:0] tmpINTERRUPT_0__MAG_SW_IN_net;
	electrical [0:0] tmpSIOVREF__MAG_SW_IN_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("8d318d8b-cf7b-4b6b-b02c-ab1c5c49d0ba"),
		  ...
		  .input_buffer_sel(2'b00))
		MAG_SW_IN
		 (.oe(tmpOE__MAG_SW_IN_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__MAG_SW_IN_net[0:0]}),
		  .io({tmpIO_0__MAG_SW_IN_net[0:0]}),
		  .siovref(tmpSIOVREF__MAG_SW_IN_net),
		  .interrupt({tmpINTERRUPT_0__MAG_SW_IN_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__MAG_SW_IN_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
    ...
    Timer_v2_70_2 RTC_PPS (
        ...
        .tc(Net_107),
        .clock(Net_10));
    defparam RTC_PPS.CaptureCount = 2;
    defparam RTC_PPS.CaptureCounterEnabled = 0;
    defparam RTC_PPS.DeviceFamily = "PSoC4";
    defparam RTC_PPS.InterruptOnCapture = 0;
    defparam RTC_PPS.InterruptOnTC = 1;
    defparam RTC_PPS.Resolution = 32;
    defparam RTC_PPS.SiliconRevision = "0";
