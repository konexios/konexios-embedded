 ...
 * Macro definitions
 **********************************************************************************************************************/
#define SF_I2C_API_VERSION_MAJOR (1)
#define SF_I2C_API_VERSION_MINOR (1)
...
typedef struct st_sf_i2c_ctrl sf_i2c_ctrl_t;
...
typedef struct st_sf_i2c_bus
{
    ...
    sf_i2c_ctrl_t         ** pp_curr_ctrl;    ///< Current device using the bus
    uint8_t               * p_bus_name;       ///< User-supplied name to identify the bus. Useful for debugging
    i2c_api_master_t      * p_lower_lvl_api;  ///< Pointer to I2C HAL interface to be used in the framework
...
/** I2C device context. DO NOT INITIALIZE.  Initialization occurs when SF_I2C_Open is called. */
struct st_sf_i2c_ctrl
{
    sf_i2c_bus_t        * p_bus;                      ///< Bus using this device. Copy from configuration structure
    i2c_cfg_t           lower_lvl_cfg;                ///< I2C peripheral configuration. Use for bus reconfiguration
    i2c_ctrl_t          lower_lvl_ctrl;               ///< I2C peripheral control block
